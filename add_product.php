<?php  
  $pageTitle = "اضافة منتجات للمنشئة";
  include 'init.php';
           ...
           ?>
                        ...
                        <div class="single_form_add_service">
                            ...
                            <h3 class="subheadline_info"  > <div class="mr-1 box_info_small"></div> 
                                ...
                                <input type="number" name="price" class="input_info"  >
                        </div>
                        ...
                        <div class="single_form_add_service">
                            ...
                            <h3 class="subheadline_info"  > <div class="mr-1 box_info_small"></div> 
                                ...
                                <input type="text" name="category" class="input_info"  >
                        </div>

                        <div class="single_form_add_service">

                            <h3 class="subheadline_info"  > <div class="mr-1 box_info_small"></div> 
                                <strong>Product Image: </strong> </h3>
                        ...
                        <input type="hidden" name="agency_id" value="<?= $agencyId[0]['id'] ?>" >
                         ...
                         <input name="add_product" type="submit" class="form_btn" value="Submit" >
